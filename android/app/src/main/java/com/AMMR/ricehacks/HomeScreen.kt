...
fun HomeTabContent(
    ...
    Column(
        ...
        DashboardCard("Health trends") {
            ...
            Text("Your connected scans and visit data will appear here as they are added.", color = colors.onSurfaceVariant, fontSize = 17.sp, lineHeight = 25.sp)
        }
        ...
        DashboardCard("Start a Presage scan") {
            ...
            Button(onClick = onStartScan, modifier = Modifier.fillMaxWidth().height(56.dp)) { Text("Start new scan", fontSize = 18.sp, fontWeight = FontWeight.SemiBold) }
        }
